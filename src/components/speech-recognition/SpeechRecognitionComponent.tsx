...
const SpeechRecognitionComponent = forwardRef<SpeechRecognitionRef, SpeechRecognitionProps>(({ onTranscript, enabled = false }, ref) => {
...
export { default as SpeechRecognitionComponent } from './SpeechRecognitionComponent'; 